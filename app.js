...
function displayData(data) {
    ...
    let html = '<table border="1" style="direction: rtl; text-align: center;"><tr><th>التاريخ</th><th>المحصول </th><th>طريقة التحضير</th><th>نسبة التركيز TDS%</th><th>الفرع</th><th>الطحنة</th><th>التركيز المناسب TDS%</th><th>الاجراء</th><th>Column S (Checkbox)</th></tr>'; // Added "Column S"
